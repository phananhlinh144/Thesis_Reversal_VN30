...
<style>
    ...
    .stTabs [data-baseweb="tab"] { 
        ...
        /* Sử dụng biến màu nền phụ của Streamlit để tự động đổi màu theo theme */
        background-color: var(--secondary-background-color); 
        border-radius: 4px 4px 0 0; 
        gap: 1px;
    }
    .stTabs [aria-selected="true"] { 
        /* Sử dụng biến màu nền chính của Streamlit */
            ...
            if len(df_plot) > 10:
                ...
                if not df_sigs.empty:
                    ...
                    fig.add_trace(go.Scatter(
                        ...
                        mode='markers',
                        # Đổi màu từ 'black' sang 'gold' (màu vàng sáng)
                        marker=dict(symbol='circle-open', size=20, color='gold', line=dict(width=3)),
                        name='Đỉnh (K10)'
                    ), row=1, col=1)
                    ...
                    fig.add_trace(go.Scatter(
                        ...
                        mode='markers',
                        # Đổi màu từ 'blue' sang 'cyan' (xanh lơ sáng)
                        marker=dict(symbol='circle-open', size=20, color='cyan', line=dict(width=3)),
                        name='Đáy (K10)'
                    ), row=1, col=1)
